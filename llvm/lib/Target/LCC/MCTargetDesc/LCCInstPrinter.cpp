//===-- LCCInstPrinter.cpp - Convert LCC MCInst to assembly syntax ------===//
//
...
//===----------------------------------------------------------------------===//
//
// This class prints an LCC MCInst to a .s file.
//
//===----------------------------------------------------------------------===//
...
void LCCInstPrinter::printRegName(raw_ostream &OS, unsigned RegNo) const {
...
void LCCInstPrinter::printUnsignedImm(const MCInst *MI, int opNum,
                                       raw_ostream &O) {
...
void LCCInstPrinter::printMemOperand(const MCInst *MI, int opNum,
                                      raw_ostream &O) {
...
//#if CH >= CH7_1
// The DAG data node, mem_ea of LCCInstrInfo.td, cannot be disabled by
// ch7_1, only opcode node can be disabled.
void LCCInstPrinter::printMemOperandEA(const MCInst *MI, int opNum,
                                        raw_ostream &O) {
