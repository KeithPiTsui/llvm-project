...
// MCObjectWriter *llvm::createCpu0ELFObjectWriter(uint8_t OSABI,
//                                                 bool IsLittleEndian) {
//   MCELFObjectTargetWriter *MOTW = new Cpu0ELFObjectWriter(OSABI);
//   auto ELFOW = createELFObjectWriter(
//       std::unique_ptr<MCELFObjectTargetWriter>(MOTW), OS, IsLittleEndian);
//   return ELFOW.release();
// }
